...
void temploop()
{
    ...
    case 0: // Attente du sifflet, détection de la couleur de départ
        ...
        if (Sifflet::active)
        {
            if (/*Couleur départ == vert*/)
            {
                state = 1;
            }
            else if (/*Couleur départ == jaune*/)
            {
                state = 2;
            }
        }
    ...
    case 1: // Suivi du vert, détection du cup
        ...
        if (/*Détecte le cup à gauche*/)
        {
            //Sort le bras à gauche
        }
        if(/*Couleur sol est blanche*/)
        {
            //Remonte le bras
            state = 3;
        }
    ...
    case 4: // On fait un tour et puis le shortcut
        ...
        if(/*Détecte la ligne noire pour une deuxième fois*/)
        {
            state = 5;
        }
        break;
